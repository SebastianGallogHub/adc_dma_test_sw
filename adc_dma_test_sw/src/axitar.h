...
#define TAR_TRANSFER_PERIOD 	100000//1ms
#elif 	TAR_MASTER_TRANSFER_PERIOD_ms==10
#define TAR_TRANSFER_PERIOD 	1000000//10ms
#elif 	TAR_MASTER_TRANSFER_PERIOD_ms == 100
#define TAR_TRANSFER_PERIOD 	10000000//100ms
#elif 	TAR_MASTER_TRANSFER_PERIOD_ms == 1000
#define TAR_TRANSFER_PERIOD 	100000000//1000ms
#elif TAR_MASTER_TRANSFER_PERIOD_ms == .1f
#define TAR_TRANSFER_PERIOD  10000
#endif
#endif

#ifdef TAR_MASTER_TRANSFER_PERIOD_us
#if TAR_MASTER_TRANSFER_PERIOD_us == 100
#define TAR_TRANSFER_PERIOD 	10000//100us
#endif
#endif
